...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-header">
                <a href="<?=base_url('jabatan/jabatanland/add');?>" class="btn btn-primary">Tambah Data</a>
            </div>
            <!-- /.box-header -->
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td valign="middle" align="center" width="10%">
                        <a href="<?php echo base_url() ?>jabatan/jabatanland/edit/<?php echo $keys->jabatan_id; ?>">Edit</a> | 
                        <a href="#!" onClick="dodelete('<?php echo base_url() ?>jabatan/jabatanland/doDelete/<?php echo $keys->jabatan_id; ?>');">Delete</a>
                      </td>
                    </tr>
                  <?php $index++; } ?>
                </tbody>
