...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-header">
                <a href="<?=base_url('workunit/workunitland/add');?>" class="btn btn-primary">Tambah Data</a>
            </div>
            <!-- /.box-header -->
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td valign="middle" align="center" width="10%">
                        <a href="<?php echo base_url() ?>workunit/workunitland/edit/<?php echo $keys->unit_kerja_id; ?>">Edit</a> | 
                        <a href="#!" onClick="dodelete('<?php echo base_url() ?>workunit/workunitland/doDelete/<?php echo $keys->unit_kerja_id; ?>');">Delete</a>
                      </td>
                    </tr>
                  <?php $index++; } ?>
                </tbody>
