...
<html>
  ...
  <body class="register-page">
    ...
    <?php 
            ...
            echo form_open('changepassword/doChangePassword'); 
        ?>
      <input type="hidden" name="email" id="email" style="width:150px;" value="<?php echo $email; ?>" />
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Retype password" name="confirmpassword" value="<?php echo set_value('confirmpassword'); ?>">
